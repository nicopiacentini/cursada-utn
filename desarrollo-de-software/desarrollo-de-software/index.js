...
const { aumentarPrecioDiario, alojamietoMasCaro } = require('./funciones.js');
...
const alojamientoMasCaro = alojamientoMasCaro(alojamientos)
console.log("el mas caro: ",  alojamientoMasCaro)