Regula la relacion entre las personas y los bienes. 
#### Definicion
Art 1882 CCyCN.
...
- Muebles e inmuebles
	...
	- inmueble -> no se puede transladar
- Fungible y no fungible -> 
	- fungible ->  puede ser reemplazado por otra especie igual. 
	- no fungible ->  tiene caracteristicas unicas e irrepetibles
- Consumible y no consumible
	- Consumible -> desaparece con el primer uso
	- No consumible -> se pueden usar reiteradas veces sin desaparecer
- Principal  y accesorias
	- Principal -> existen por si solas
	- Accesorias -> dependen de un principal
- Divisible e indivisible
	- Divisible -> pueden partirse
	- Indivisible -> pierde su valor al dividirse.
###### Casos adicionales
- Frutos y productos
...
#### Sobre cosa propia
#### Dominio
Es un derecho real que me permite usar y gozar de un bien material. Es perfecto cuando puedo usarlo con cualquier facultad. Es *imperfecto* al estar sujeto por condicion.
##### Caracteres de dominio
- Exclusivo -> dos personas no pueden tener dominio absoluto sobre una cosa
- Excluyente -> el dueño puede exigir que otros no usen o gozen de su cosa
- Perpetuo -> no tiene limite en el tiempo
##### Extension
Son todos los elementos que formen parte de la cosa. En el caso de inmueble abarca subsuelo y espacio aereo.
##### Dominio Vs posesion o tenencia
El dominio es el derecho. La posesion es actuar como si fuese el dueño. Se dice que es el poseedor de la cosa
...
Es un derecho real que se ejerce sobre un inmueble propio y da derechos sobre partes privativas y comunes de inmueble al dueño. Por ejemplo, en un departamento sos propietario de tu departamento y copropietario de espacios comunes.
- Requiere una constitucion que reglamente. Determina reglas comunes como quien es el administrador, relaciones consorciales, si pueden haber mascotas
- Unidad funcional -> es un piso/departamento con independencia funcional y comunicacion con la via publica. Esta comprendida por
	- La parte indivisa del terreno
	- La parte indivisa de las casas
###### Partes necesariamente comunes
Pasillos, paredes, ascensores, escaleras
###### Partes comunes no indispensables
Piscina, gimnacio o laundry.
###### Expensas
Las pagan todos los propietarios El consorcio es el acreedor propietario.

##### Hipoteca
Es el derecho real de garntia hipoteca. Recae sobre uno o mas inmuebles individualizados. Le otorga la facultad de persecucion y preferncia para cobrar el credito al acreedor.
###### Caracteres
- Se extingue cuando se extingue el credito. Accesorio a la deuda
- Se pone solo sobre inmuebles
- Es convencional
- Es indivisible -> la deuda es sobre todo el inmueble, si se paga un pedazo, sigue siendo perseguible el inmueble entero
Puede ser sujeta a graduacion:
Sobre un mismo bien inmueble se pueden constituir VARIAS hipotecas. Para que sea posible materialmente es importante el valor del bien.
###### Extinsion
Con el pago al acreedor hipotecario se extingue el credito y la hipoteca como accesorio. Su cancelacion debe quedar escrita
###### Sujetos que pueden constituirla
Son los titulares de derechos reales de:
- Dominio
- Condominio
- Propiedad horizontal
...
- Superficie
##### Prenda
Derecho de garantia  sobre muebles. Se constituye por el dueño de la cosa y la cosa como tal. Se establece por contrato o por tradicion al acreedor prendario.
- Acreedor prendario -> Tiene posesion de la cosa. No puede disponer de ella ni ejercer derecho de propiedad.
###### Tipos de prenda
- Prenda con desplazamiento -> La cosa se la queda el acreedor hasta que finaliza el credito
- Prenda sin desplazamiento -> La cosa se la queda el deudor hasta que finaliza el credito. z
- Prenda con registro -> se rige por decreto/ley 
##### Usufructo
Es el derecho de usar, gozar y percibir los frutos de un bien ajeno sin alterar su sustancia. Es temporal y finaliza con la muerte de usufructario.
###### Formas de constitucion 
- Contrato oneroso o gratuito
- Testamento
En el caso de las personas juridicas se constituye por un maximo de 20 años. 
- nuda propiedad -> no por ser el dueño se puede gozar de los frutos.
##### Servidumbre
Establece un derecho real entre inmuebles donde el dueño del inmueble dominante puede hacer cosas sobre el inmueble sirviente. Puede ser constituida :
- A favor de una persona determianda (personal)
- A favor de inmueble determinado
Se extingue si se desarman los inmuebles, deshuso, se termina el objeto original, etc.
##### Superficie
